...
export const metadata: Metadata = {
  ...
  description:
    'Privacy Policy for HomeStock — what we collect, how we use it, and your rights under GDPR and CCPA.',
};
    ...
    >
      ...
      <ul>
        ...
        <li>
          ...
          with a party, whereas &quot;control&quot; means ownership of 50% or more of the shares, equity interest
        ...
        <li>
          ...
          any electronic device, and developed by Home Tasker LTD.
        </li>
        <li>
        ...
        <li>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to HOME TASKER – CLEANING SCHEDULE
          ORGANIZER LTD, 43/8 Gardner&apos;s Crescent, Edinburgh, EH3 8DG, United Kingdom. For the purpose of the
        ...
        <li>
          ...
          the physical, physiological, genetic, mental, economic, cultural or social identity. For the purposes
          of the CCPA, Personal Data means any information that identifies, relates to, describes or is capable
        ...
        <li>
          ...
          Service or to assist the Company in analyzing how the Service is used. For the purpose of the GDPR,
        ...
        <li>
          <strong>Website</strong> refers to Home Stock, accessible from{' '}
          <a href="https://home-stock.io/">https://home-stock.io/</a>
        </li>
        <li>
          <strong>You</strong> means the individual accessing or using the Service, or the company, or other
          legal entity on behalf of which such individual is accessing or using the Service, as applicable. Under
      ...
      <h3>2.4 Information Collected while Using the Application</h3>
      <p>
      ...
      <h3>2.5 Tracking Technologies and Cookies</h3>
      <p>
      ...
      <ul>
        ...
        <li>
          <strong>Tracking and Performance Cookies.</strong> Type: Persistent Cookies. Administered by:
          ...
          a pseudonymous identifier associated with the device you use to access the Website. We may also use
      ...
      <h3>2.6 Use of Your Personal Data</h3>
      ...
      <ul>
        ...
        <li>
          <strong>To provide You with news, special offers and general information</strong> about other goods,
      ...
      <h3>2.7 Retention of Your Personal Data</h3>
      <p>
      ...
      <h3>2.8 Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3>2.9 Disclosure of Your Personal Data</h3>
      <p>
        We may disclose your personal data under certain circumstances, such as in business transactions or to
        comply with legal requirements. This section explains those circumstances in more detail.
      </p>

      <h3>2.10 Business Transactions</h3>
      <p>
      ...
      <h3>2.12 Other legal requirements</h3>
      ...
      <h3>2.13 Security of Your Personal Data</h3>
      <p>
      ...
      <h3>2.14 How to Request Deletion of Your Personal Data</h3>
      <p>
        You may request the deletion of your personal data at any time by contacting us at{' '}
        <a href="mailto:support@home-stock.io">support@home-stock.io</a>. Once we receive and confirm your
        request, we will delete your personal data from our records unless a legal obligation or legitimate
        interest (such as completing financial transactions, resolving disputes, or complying with regulatory
        requirements) requires us to retain certain information. We will make every reasonable effort to respond
        promptly and, in any event, within the timeframe required by applicable law.
      </p>

      <h2>3. Detailed Information on the Processing of Your Personal Data</h2>
      <p>
      ...
      <ul>
        <li>
          ...
          contextualize and personalize the ads of its own advertising network. You can opt-out of having made
          ...
          from sharing information with Google Analytics about visits activity. You may opt-out of certain Google
          Analytics features through your mobile device settings, such as your device advertising settings or by
          following the instructions provided by Google in their Privacy Policy:{' '}
          <a href="https://policies.google.com/privacy">https://policies.google.com/privacy</a>. For more
          information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web page:{' '}
          <a href="https://policies.google.com/privacy">https://policies.google.com/privacy</a>.
        </li>
      </ul>

      <h3>3.2 Email Marketing</h3>
      <p>
      ...
      <ul>
        <li>
          <strong>Mailchimp.</strong> Their Privacy Policy can be viewed at{' '}
          <a href="https://mailchimp.com/help/data-privacy">https://mailchimp.com/help/data-privacy</a>.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Apple Store In-App Payments.</strong> Their Privacy Policy can be viewed at{' '}
      ...
      <h3>4.1 Legal Basis for Processing Personal Data under GDPR</h3>
      ...
      <ul>
        ...
        <li>
          <strong>Performance of a contract:</strong> Provision of Personal Data is necessary for the performance
        ...
        <li>
          <strong>Public interests:</strong> Processing Personal Data is related to a task that is carried out in
      ...
      <h3>4.2 Your Rights under the GDPR</h3>
      <p>
      ...
      <ul>
        ...
        <li>
          <strong>Request correction of the Personal Data that We hold about You.</strong> You have the right to
          have any incomplete or inaccurate information We hold about You corrected.
        </li>
        <li>
          <strong>Object to processing of Your Personal Data.</strong> This right exists where We are relying on
          a legitimate interest as the legal basis for Our processing and there is something about Your
        ...
        <li>
          ...
          format. Please note that this right only applies to automated information which You initially provided
      ...
      <h3>4.3 Exercising of Your GDPR Data Protection Rights</h3>
      <p>
        You may exercise Your rights of access, rectification, cancellation and opposition by contacting Us.
        Please note that we may ask You to verify Your identity before responding to such requests. If You make a
      ...
      <h3>5.1 Categories of Personal Information Collected</h3>
      <p>
      ...
      <ul>
        <li>
          <strong>Category A: Identifiers.</strong> Examples: A real name, alias, postal address, unique personal
          identifier, online identifier, Internet Protocol address, email address, account name, driver&apos;s
          license number, passport number, or other similar identifiers. Collected: Yes.
        </li>
        <li>
          <strong>Category B: Personal information categories listed in the California Customer Records statute
          (Cal. Civ. Code § 1798.80(e)).</strong> Examples: A name, signature, Social Security number, physical
          characteristics or description, address, telephone number, passport number, driver&apos;s license or
          state identification card number, insurance policy number, education, employment, employment history,
        ...
        <li>
          <strong>Category D: Commercial information.</strong> Examples: Records and history of products or
          services purchased or considered. Collected: Yes.
        </li>
        <li>
          <strong>Category E: Biometric information.</strong> Examples: Genetic, physiological, behavioral, and
          biological characteristics, or activity patterns used to extract a template or other identifier or
          identifying information, such as, fingerprints, faceprints, and voiceprints, iris or retina scans,
          keystroke, gait, or other physical patterns, and sleep, health, or exercise data. Collected: No.
        </li>
        <li>
          <strong>Category F: Internet or other similar network activity.</strong> Examples: Interaction with our
          Service or advertisement. Collected: Yes.
        </li>
        <li>
          <strong>Category G: Geolocation data.</strong> Examples: Approximate physical location. Collected: No.
        </li>
        <li>
          <strong>Category H: Sensory data.</strong> Examples: Audio, electronic, visual, thermal, olfactory, or
          similar information. Collected: No.
        </li>
        <li>
          <strong>Category I: Professional or employment-related information.</strong> Examples: Current or past
          job history or performance evaluations. Collected: No.
        </li>
        <li>
          <strong>Category J: Non-public education information</strong> (per the Family Educational Rights and
          Privacy Act (20 U.S.C. Section 1232g, 34 C.F.R. Part 99)). Examples: Education records directly related
          to a student maintained by an educational institution or party acting on its behalf, such as grades,
          transcripts, class lists, student schedules, student identification codes, student financial
          information, or student disciplinary records. Collected: No.
        </li>
        <li>
          <strong>Category K: Inferences drawn from other personal information.</strong> Examples: Profile
          reflecting a person&apos;s preferences, characteristics, psychological trends, predispositions,
          behavior, attitudes, intelligence, abilities, and aptitudes. Collected: No.
        </li>
      </ul>
      ...
      <h3>5.2 Sources of Personal Information</h3>
      ...
      <ul>
        ...
        <li>
          <strong>Automatically from You.</strong> For example, through cookies We or our Service Providers set
      ...
      <h3>5.3 Use of Personal Information for Business Purposes or Commercial Purposes</h3>
      <p>
      ...
      <h3>5.4 Disclosure of Personal Information for Business Purposes or Commercial Purposes</h3>
      <p>
      ...
      <p>
        ...
        belief to the best of our knowledge that some of that information from the applicable category may be and
      ...
      <h3>5.5 Sale of Personal Information</h3>
      <p>
        ...
        or by electronic or other means, a consumer&apos;s personal information by the business to a third party
        for valuable consideration. This means that We may have received some kind of benefit in return for
      ...
      <h3>5.6 Share of Personal Information</h3>
      ...
      <h3>5.7 Sale of Personal Information of Minors Under 16 Years of Age</h3>
      <p>
        ...
        children&apos;s Internet usage and instruct their children to never provide information on other
      ...
      <p>
        ...
        age. Consumers who opt-in to the sale of personal information may opt-out of future sales at any time. To
      ...
      <h3>5.8 Your Rights under the CCPA</h3>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              We will disclose to You: the categories of personal information categories sold and the categories
        ...
        <li>
          ...
          exception applies. We may deny Your deletion request if retaining the information is necessary for Us
      ...
      <h3>5.9 Exercising Your CCPA Data Protection Rights</h3>
      <p>
        In order to exercise any of Your rights under the CCPA, and if You are a California resident, You can
        contact Us:
      </p>
      <ul>
        <li>By email: <a href="mailto:support@home-stock.io">support@home-stock.io</a></li>
        <li>By visiting this page on our website: <a href="https://home-stock.io/">https://home-stock.io/</a></li>
      </ul>
      <p>
      ...
      <h3>5.10 Do Not Sell My Personal Information</h3>
      <p>
      ...
      <h2>6. &quot;Do Not Track&quot; Policy as Required by California Online Privacy Protection Act (CalOPPA)</h2>
      ...
      <h2>8. Your California Privacy Rights (California&apos;s Shine the Light law)</h2>
      <p>
      ...
      <h2>9. California Privacy Rights for Minor Users (California Business and Professions Code Section 22581)</h2>
      <p>

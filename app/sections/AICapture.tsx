      ...
      <Container className="relative grid grid-cols-12 items-center gap-8">
        <div className="col-span-12 md:col-span-6">
          ...
          <p className="mt-6 max-w-md text-xl leading-[1.6] text-white/70">
            Take a photo. Our AI fills in the name,
            category, and estimated price in 3 seconds.
            <br /><br />
            Edit if you like. Or just save and forget.
          </p>
          <div className="mt-6 flex items-end gap-8">
            <div>
              <div className="text-3xl font-bold text-[#66B2FF]">1</div>
              <div className="text-xs text-white/50">photo</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#66B2FF]">4</div>
              <div className="text-xs text-white/50">fields</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#66B2FF]">3s</div>
        ...
        <div className="relative col-span-12 flex justify-center md:col-span-6 md:justify-end">
          ...
          {/* Floating AI captured chip */}
          <div className="absolute -left-2 top-1/3 rounded-2xl bg-white px-4 py-3 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">

    ...
    <section id="pricing" className="relative overflow-hidden bg-deep py-32">
      <Container className="text-center">
        <div className="inline-flex">
          <Eyebrow label="PRICING" dotColor="#948F99" />
        </div>
        <h2 className="mx-auto mt-6 max-w-3xl text-[48px] font-bold leading-[1.05] tracking-tighter2 md:text-[56px]">
          Free to start.<br />Pro when you&apos;re ready.
        </h2>

        <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-3">
          {/* FREE */}
          <div className="rounded-3xl bg-[#1A1A1F] p-8 text-left">
          ...
          {/* YEARLY (highlighted) */}
          <div className="relative -mt-4 rounded-3xl border-[1.5px] border-accent bg-white p-8 text-left text-deep shadow-[0_30px_100px_-10px_rgba(0,122,255,0.40)]">
            ...
            <button className="mt-6 w-full rounded-full bg-accent py-3 text-sm font-semibold text-white transition hover:bg-accent/90">
              Start free trial &nbsp;→
            </button>
          </div>

          {/* MONTHLY */}
          <div className="rounded-3xl bg-white p-8 text-left text-deep shadow-[0_12px_30px_-5px_rgba(0,0,0,0.06)]">
            ...
            <button className="mt-6 w-full rounded-full border border-deep/20 py-3 text-sm font-semibold text-deep transition hover:bg-deep/5">
              Subscribe
            </button>
          </div>
        </div>

    ...
    <section className="relative overflow-hidden bg-deep py-32">
      ...
      <Container className="relative grid grid-cols-12 items-center gap-8">
        ...
        <div className="col-span-12 flex justify-center md:col-span-6">
          <div className="w-[420px] max-w-full rounded-3xl border border-white/8 bg-[#1A1A1F] p-7 shadow-[0_30px_80px_-10px_rgba(0,0,0,0.5)]">
            ...
            <div className="mt-4 space-y-2">
              {rooms.map((r) => (
                <div key={r.name} className="flex items-center gap-3 rounded-2xl bg-white/[0.04] p-3">
        ...
        <div className="col-span-12 md:col-span-6 md:pl-12">
          <Eyebrow label="ORGANIZATION" />
          <h2 className="mt-5 text-[56px] font-bold leading-[1.02] tracking-tighter3 md:text-[64px]">
            Your home,<br />in folders.
          </h2>
